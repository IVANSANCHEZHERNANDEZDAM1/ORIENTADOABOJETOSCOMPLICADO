...
public class MAIN {
	...
	public static void main(String[] args) throws IOException {
		...
		do {
			...
			System.out.println("|| (1)ADD INGREDIENTE || (2)DEL INGREDIENTE || (3)ADD PASO || (4)DEL PASO || (5)VER INGREDIENTES || (6)VER PASOS || (-1)SALIR");
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("DEL INGREDIENTE");
			...
			case 4:
				...
				System.out.println("NUMERO DE PASO (ver listado, para ver listado pulsa -1): ");
				b = Integer.parseInt(lector.readLine());
				if (b == -1) {
					receta.verPasos();
					break;
				...
				break;
			case 5:
				System.out.println("VER INGREDIENTES");
				receta.verIngredientes();
				break;
			case 6:
				...
				break;
			default:
				System.out.println("Numero incorrecto,pon un numero que este en la pantalla");
